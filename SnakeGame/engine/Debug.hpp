...
#define HZ_PROFILE 0
	...
	#define HZ_PROFILE_BEGIN_SESSION(name, filepath) ::GL_ENGINE::Instrumentor::Get().BeginSession(name, filepath)
	#define HZ_PROFILE_END_SESSION() ::GL_ENGINE::Instrumentor::Get().EndSession()
	#define HZ_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::GL_ENGINE::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
											   ::GL_ENGINE::InstrumentationTimer timer##line(fixedName##line.Data)
